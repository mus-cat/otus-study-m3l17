...
Правильными варинтами, на мой взгляд, являются 2 и 3. Вариант с отключением SELinux с точки зрения безопасности, наименее верный. Про вариант с использованием модуля созданного с применением программы **audit2allow** написано в конце. Поэтому был выбран вариант с назначением контекста "руками" на папку **/etc/named/dynamic/**
